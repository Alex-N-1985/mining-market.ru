<p class="breadcrumbs"><a href="http://<?=$rout->domain.$rout->start?>">Главная</a> > Админпанель </p>
...
<section class="admin">
    ...
    <a class="admin-item" href="http://<?=$rout->domain.$rout->start?>/admin/viewusers">Пользователи</a>
    <h4>Связи между сущностями:</h4>
    <a class="admin-item" href="http://<?=$rout->domain.$rout->start?>/admin/viewcatsimages">Категории-изображения</a>
</section>